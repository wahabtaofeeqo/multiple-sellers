...
class paypal extends MX_Controller {
	...
	public function __construct(){
		...
		if (isset($id)) {
			...
			$this->currency_code = (get_option("currency_code_".$id, "USD") == "")? 'USD' : get_option("currency_code", "USD");
			$this->load->library("paypalapi");
			$this->paypal = new paypalapi(get_option('paypal_client_id_'.$id,""), get_option('paypal_client_secret_'.$id,""));
		}else{
