    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-options">
          <a href="<?=cn($module."/auto_sync_services_setting")?>" class="ajaxModal d-none btn btn-pill btn-info btn-sm"><span class="mr-1"><i class="fe fe-refresh-cw"></i></span> <?=lang("auto_sync_services_setting")?>
          </a>
