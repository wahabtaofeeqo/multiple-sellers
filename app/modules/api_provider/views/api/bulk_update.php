          ...
          <div class="modal-body">
            <div class="form-body">
              <div class="row justify-content-md-center">
				...
				<div class="col-md-12">
                  <div class="form-group">
                    <input type="text" style="display:none" class="form-control square" name="chekopt" id="chekopt">
                  </div>
                </div>				
				<div class="col-md-12">
                  <div class="form-group">
                    <input type="text" style="display:none" class="form-control square" name="s_opt" id="s_opt">
                  </div>
                </div>
                <div class="col-md-12">
