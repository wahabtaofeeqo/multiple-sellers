...
class module extends MX_Controller {
	...
	public function index(){
		...
		if (!empty($purchase_code_item)) {
			...
			$domain = base_url();
			$url = "https://nguyentuyen.tk/pc_verify/script_list?purchase_code=".urlencode($purchase_code);
	...
	public function ajax_install_module(){
		...
		$domain = base_url();
		$url = "https://nguyentuyen.tk/pc_verify/install?type=install&main=0&purchase_code=".urlencode($purchase_code)."&domain=".urlencode($domain);
	...
	public function ajax_upgrade_module($purchase_code = ""){
		...
		$domain = base_url();
		$url = "https://nguyentuyen.tk/pc_verify/install?type=upgrade&purchase_code=".urlencode($purchase_code)."&domain=".urlencode($domain);
