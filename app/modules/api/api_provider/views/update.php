              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group"hidden>
                    ...
                    <input type="text" class="form-control square" name="name" value="<?=(!empty($api->name))? $api->name: ''?>"hidden>
                  </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group"hidden>
                    <label >URL</label>
                    <input type="text" class="form-control square" name="api_url" value="<?=(!empty($api->url))? $api->url: ''?>"hidden>
                  </div>
                </div>
