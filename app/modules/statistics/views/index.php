          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex order-lg-2 ml-auto">
              ...
              <div class="ml-2 d-lg-block text-right">
                ...
                <h4 class="m-0 text-right number"><?=get_option('currency_symbol_'.session('uid'),"$")?><?=(!empty($data_log->user_balance)) ? currency_format($data_log->user_balance, get_option('currency_decimal', 2), $decimalpoint, $separator) : 0?></h4>
				<?php } ?>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex order-lg-2 ml-auto">
              ...
              <div class="ml-2 d-lg-block text-right">
				...
				?>
                <h4 class="m-0 text-right number"><?=get_option('currency_symbol_'.session('uid'),"$")?><?=(!empty($data_log->total_spent_receive)) ? currency_format($data_log->total_spent_receive, get_option('currency_decimal_'.session('uid'), 2), $decimalpoint, $separator) : 0?></h4>

                <small class="text-muted ">

                  <?=(get_role("m-seller") ? lang("total_amount_recieved") : lang("total_amount_spent"))?>
