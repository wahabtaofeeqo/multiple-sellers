  ...
  <div class="modal-right">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <?php
          $url = cn($module."/ajax_add_sub_category");
        ?>
        <form class="form actionFor" action="<?=$url?>" data-redirect="<?=cn($module)?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fa fa-edit"></i><?=lang('Add Sub Category')?></h4>
              ...
              <div class="row justify-content-md-center">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="target" class="form-control square"  name="name" value="<?=(!empty($category->name))? $category->name: ''?>">
                  </div>
                </div> 
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label ><?=lang('Category')?></label>
                   <select name="cateegory_id" class="form-control square">
