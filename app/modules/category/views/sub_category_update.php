    ...
    <div class="modal-right">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <?php
                $id = (!empty($sub_category->id)) ? $sub_category->id : '';

                if ($id != "") {

                    $url = cn($module . "/ajax_update_sub_category/$id");

                } else {

                    $url = cn($module . "/ajax_update_sub_category");
                ...
                <form class="form actionForm" action="<?=$url?>" data-redirect="<?=cn($module)?>" method="POST">
                    <div class="modal-header bg-pantone">
                        <h4 class="modal-title"><i class="fa fa-edit"></i>Update Sub Category</h4>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="target" class="form-control square"  name="name" value="<?=(!empty($sub_category->name))? $sub_category->name: ''?>">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control square" name="sort"  value="<?=(!empty($sub_category->sort))? $sub_category->sort: ''?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control square">
                                            <option value="1" <?=(!empty($sub_category->status) && $sub_category->status == 1) ? 'selected' : ''?>><?=lang("Active")?></option>
                                            <option value="0" <?=(isset($sub_category->status) && $sub_category->status != 1) ? 'selected' : ''?>><?=lang("Deactive")?></option>
                                        </select>
                                    </div>
                                </div>
								   ...
								   <div class="col-md-12 col-sm-12 col-xs-12 seller_permission_area">
									   <div class="form-group">
										   ...
										   <select  id="seller_permission" name="seller_permission[]" class="form-control square" multiple="multiple">
											   ...
											   $muti_arr=explode(',', $sub_category->seller_permission);
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" id="editor" class="form-control square" name="desc" placeholder="About Project"><?=(!empty($sub_category->desc))? $sub_category->desc: ''?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
