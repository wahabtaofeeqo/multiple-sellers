...
?>
<style>
<? if(!empty($lang_current) && $lang_current->code == 'ar'){ ?>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="form-group">
                ...
                <div class="custom-controls-stacked">
                  ...
                  <label class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" name="is_payment_notice_email_<?=session('uid')?>" value="0">

                    <input type="checkbox" class="custom-control-input" name="is_payment_notice_email_<?=session('uid')?>" value="1" <?=(get_option('is_payment_notice_email_'.session('uid'),"") == 1)? "checked" : ''?>>
                ...
                <div class="custom-controls-stacked">
                  ...
                  <label class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" name="is_ticket_notice_email_<?=session('uid')?>" value="0">

                    <input type="checkbox" class="custom-control-input" name="is_ticket_notice_email_<?=session('uid')?>" value="1" <?=(get_option('is_ticket_notice_email_'.session('uid'),"") == 1)? "checked" : ''?>>
                ...
                <div class="custom-controls-stacked">
                  ...
                  <label class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" name="is_order_notice_email_<?=session('uid')?>" value="0">

                    <input type="checkbox" class="custom-control-input" name="is_order_notice_email_<?=session('uid')?>" value="1" <?=(get_option('is_order_notice_email_'.session('uid'),"") == 1)? "checked" : ''?>>
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="email_from_<?=session('uid')?>" value="<?=get_option('email_from_'.session('uid'),"")?>">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="email_name_<?=session('uid')?>" value="<?=get_option('email_name_'.session('uid'),"")?>">
