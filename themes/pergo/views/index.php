        ...
        <div class="row text-center">
          <div class="col-md-12">
            <div class="content">
              ...
              <p><?=lang("we_have_several_services_that_you_can_opt_for_backed_by_our_comprehensive_guarantee_click_the_button_below_to_find_out_more")?></p>
            </div>
            <div class="button">
              <a href="<?=cn("auth/signup")?>" class="btn btn-pill btn-gradient btn-signin btn-lg"><?=lang("get_start_now")?></a>
            </div>
            </div>
          </div>
        </div>
